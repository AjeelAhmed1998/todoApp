      ...
      >
        ...
        <View>
          ...
          <View style={styles.todosWrp}>
            <View style={styles.listHeaderWrp}></View>
            <ScrollView>
              <Todos
                todos={this.state.todos}
                //I'm passing this down from this Main component to Todos basically
                //which then passes on to it's Todo component as a prop
